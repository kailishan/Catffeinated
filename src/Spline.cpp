...
Spline::Spline(glm::vec3 start, glm::vec3 control, glm::vec3 end,
               float duration) {
  t = 0;
  order = ORDER2;
  done = false;
...
Spline::Spline(glm::vec3 start, glm::vec3 control1, glm::vec3 control2,
               glm::vec3 end, float duration) {
  t = 0;
  order = ORDER3;
  done = false;
  this->start = start;
...
bool Spline::isDone() { return done; }
