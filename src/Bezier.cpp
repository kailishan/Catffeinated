...
glm::vec3
Bezier::quadBez(glm::vec3 (*interpolation)(glm::vec3, glm::vec3, float),
                glm::vec3 a, glm::vec3 b, glm::vec3 control, float t) {
...
glm::vec3 Bezier::cubeBez(glm::vec3 (*interpolation)(glm::vec3, glm::vec3,
                                                     float),
                          glm::vec3 a, glm::vec3 b, glm::vec3 control1,
                          glm::vec3 control2, float t) {
  // determine which interpolation function to use.
  // NULL sets the default to linear interpolation
  interpolation = interpolation ? interpolation : lErp;
